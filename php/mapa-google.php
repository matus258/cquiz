<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDoO-8I2cpXRj4yI0UzwWw7YC5bUR-rdE8&callback=initMap"
  type="text/javascript"></script>
    ...
    <?php include 'navbar.php';?>
		...
		<div id="map" style="margin-left: 230px;"></div>
